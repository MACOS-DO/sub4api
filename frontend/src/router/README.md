...
This directory contains the Vue Router configuration for the Sub4API frontend application. The router implements a comprehensive navigation system with authentication guards, role-based access control, and lazy loading.
