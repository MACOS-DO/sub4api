...
const GITHUB_REPO = 'MACOS-DO/sub4api'
// Docker Hub image published by CI (tags carry no "v" prefix, e.g. ghcr.io/macos-do/sub4api:0.1.146)
const DOCKER_IMAGE = 'ghcr.io/macos-do/sub4api'
