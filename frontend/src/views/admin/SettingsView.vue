          ...
          <div class="card">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="flex items-center justify-between gap-4">
                  ...
                  <input id="codex-ticket-ttl" v-model.number="form.openai_codex_ticket_ttl_seconds" type="number" min="60" max="86400" step="1" class="input w-32 text-sm" />
                </div>
                <div class="flex items-center justify-between gap-4">
                  <div class="min-w-0">
              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || "Sub4API") +
                        " 100 " +
                ...
                <!-- Row 4: Enabled payment types (provider badges like sub4apipay) -->
                <div>
                  <label class="input-label">{{
...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/MACOS-DO/sub4api/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/MACOS-DO/sub4api/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/MACOS-DO/sub4api/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/MACOS-DO/sub4api/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
