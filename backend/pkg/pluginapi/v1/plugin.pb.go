...
// Wire namespace retained for installed v1 plugins; Go imports use the new module.
...
var file_pkg_pluginapi_v1_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
