...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	codexLocationCache := repository.NewCodexLocationCache(redisClient)
	proxyRepository := repository.NewProxyRepository(client, db, codexLocationCache)
	...
	accountRepository := repository.NewAccountRepository(client, db, schedulerCache, codexLocationCache)
	...
	adminAccountRepository := repository.NewAdminAccountRepository(client, db, schedulerCache, codexLocationCache)
